...
def main(argv: list[str] | None = None) -> int:
    ...
    # Register every robot variant this repo supports, not just Panda -- this
    # script is dataset-agnostic (env_id/robot come from the dataset's own
    # metadata.json, read below), so it needs to work whether the dataset was
    # generated by write_maniskill_reach_dataset.py (Panda) or one of the xArm7
    # wrapper scripts, without the caller having to know which registration
    # function that particular dataset needs.
